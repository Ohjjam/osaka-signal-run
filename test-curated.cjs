...
(async()=>{
 ...
 try {
  ...
  console.log('PASS: 13 schedules, rich menu/reasons, per-route aquarium time, Sunday castle+sushi, Monday aquarium, Monday deadline, apply/undo/map/reload, mobile fits, no JS errors.');
