...
let sw=fs.readFileSync(path.join(root,'sw.js'),'utf8').replace(/const CACHE = '[^']+';/,"const CACHE = 'osaka-guide-local-v46';");
...
console.log('Static build complete: matching entries, revision 46, offline shell and JS syntax.');
