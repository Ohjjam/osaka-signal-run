(function(){
 ...
 D.details.art51={why:'전망대·쇼핑 대신 그림을 천천히 보는 90분. 2026/7/4–9/27 카를 발저 전 관람.',order:'카를 발저 전 4층 전시. 페르메이르 전은 별도 전시·티켓이므로 이 코스에 포함하지 않음.',tip:'공식 10–17시, 입장16:30까지. 일반1800엔, 날짜·시간 지정제 아님. 아직 티켓 구매 안 됨. 15시 입장 목표, 혼잡·임시 변경 확인.',source:'https://nakka-art.jp/exhibition-post/karlwalser-2026/'};
 ...
 D.days.sun=[
  route('sun-skyline51','A · 쇼핑·고층 야경','도시 풍경 / 전망권 별도','스시 뒤 우메다에 집중. 쇼핑 → 해 질 무렵 공중정원 → 오코노미야키. 미술관·신사·상점가 순례는 넣지 않았습니다.','쇼핑을 좋아하고 대표 야경을 보고 싶으면 A. 날씨가 흐리면 전망대 입장 전 시야 확인. 저녁 키지 대기가 길면 같은 건물 식당가에서 교체.',45,[s('umeda-break45','14:45',120,30),s('sky','17:15',90,20),s('kiji','19:05',90,45,'dinner'),s('back-hotel45','21:20',15,0)]),
  route('sun-art51','B · 미술 전시·강변 산책','예술·건축 / 전시1800엔','스시 뒤 나카노시마로 이동. 카를 발저 전 → 미술관 레스토랑 → 강변·공회당 외관. 우메다 쇼핑과 전망대는 전부 제외했습니다.','그림·건축·조용한 산책을 좋아하면 B. 15시 전시 입장을 지키고, 스시 대기가 길면 식사 후 강변 산책을 줄이기. 월요일 수족관과 다른 실내 관람 경험.',60,[s('art51','15:00',90,15),s('karato51','16:45',75,30,'dinner'),s('nakanoshima50','18:30',75,45),s('back-hotel45','20:30',15,0)]),
  route('sun-local51','C · 상점가·신사·닭꼬치','로컬 골목 / 유료 명소 없음','스시 뒤 텐진바시스지를 남쪽으로 내려가 텐만구 참배·카페·닭꼬치. 쇼핑몰·고층 전망·미술관 대신 동네 골목과 먹거리에 시간을 씁니다.','관광시설 입장료를 줄이고 편하게 먹고 걸으려면 C. 상점가 전체를 완주하지 않고 텐마–미나미모리마치 구간만. 카페는 현장에서 열린 곳을 고릅니다.',15,[s('tenjin50','14:15',60,30),s('temmangu51','15:45',45,15),s('tenma-cafe51','16:45',45,15,'snack'),s('toriki51','17:45',90,45,'dinner'),s('back-hotel45','20:00',15,0)])
 ];
