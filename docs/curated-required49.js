(function(){
 ...
 D.places.push(
  ...
  log('rinku-airport53','아웃렛 짐 회수 → 린쿠타운역 → 공항',rinku,'15시까지 짐을 회수하고 도보로 린쿠타운역. JR 또는 난카이 공항행 한 정거장. 터미널까지 여유 포함 60분.',rail)
 );
 ...
 D.details['rinku-lunch53']={why:'같은 시설 안 푸드홀이라 따로 식당을 찾아 멀리 움직이지 않습니다.',order:'당일 열린 점포에서 라멘·우동·덮밥 중 한 그릇. 1인 1000–1600엔 계획 예산, 실제 가격은 현장 메뉴판 확인.',tip:'11시 이후 점포별 영업 확인. 13:45에는 식사를 마치기. 줄이 길면 포장·공항 식사로 바꿔 짐 회수를 늦추지 않기.',source:'https://www.premiumoutlets.co.jp/rinku/brands/'};
 D.airportDepartures={
 ...
 D.airportPlan=[
  {time:'16:00',title:'출국 터미널 도착 · 체크인·짐 부치기',text:'18:00 비행 기준 목표. 항공사·T1/T2부터 확인하고 수속 우선. T2·많은 위탁수하물·항공사의 별도 안내가 있으면 전체 코스를 30분 이상 앞당기기.'},
  {time:'16:30',title:'보안검색·출국심사 우선',text:'혼잡하면 추가 쇼핑 생략. 항공사 체크인·탑승 마감 안내가 이 계획보다 우선합니다.'},
  {time:'16:45',title:'시간이 남으면 음료·간식',text:'점심은 세 코스 모두 시내·린쿠에서 먹습니다. 수속 후 여유가 있을 때만 간단한 간식. 줄이 길면 생략.'},
  {time:'17:00',title:'탑승구 확인 · 가까이서 대기',text:'탑승권·전광판에서 실제 탑승 시작과 마감 시각을 확인. 18:00 이륙 예정이며 18시에 탑승구로 가는 것이 아닙니다.'}
 ];
 const flightNote='사용자가 알려준 18:00 KIX 출발 기준, 16:00 출국 터미널 도착 목표. 항공사·터미널·수속 마감은 탑승권으로 확인. T2 또는 수하물이 많으면 코스를 30분 이상 앞당기기. 짐은 체크아웃 때 전부 챙기며 숙소 보관은 가정하지 않음. 열차 시각은 예약이 아닌 이동 여유를 포함한 계획값.';
 ...
 D.places.push(
  {...extra('donki-mega54','MEGA 돈키호테 신세카이점',mega,'넓게 쇼핑할 대형 돈키호테. 과자·식품·생활용품·화장품·의류 등을 한 번에 둘러보기.',donkiSource,'goods'),jp:'MEGAドン・キホーテ新世界店',address:'大阪市浪速区恵美須東3-4-36',duration:120,priceText:'구매 금액 별도',map:'https://www.google.com/maps?cid=2127241197779954162'},
  ...
  log('rinku-airport54','린쿠타운역 → 간사이공항',rinkuStation,'짐을 가지고 역으로 복귀. 15시까지 공항행 승강장으로 이동하고 한 정거장 뒤 하차.',rail)
 );
 ...
 D.details.sumiyoshi53={...D.details.sumiyoshi53,why:'남쪽 신사에서 붉은 다리와 본전을 본 뒤 대형 돈키와 꼬치 점심으로 이어지는 코스. 큰 짐은 신이마미야역에 둡니다.',tip:'4–9월 공식 참배시간 06–17시. 일반 참배 무료. 신사 구경 후 보통열차로 신이마미야에 돌아와 대형 돈키에 들르기. 11:15 신사 출발 목표; 지연되면 돈키·공항 시간 우선.'};
 ...
 const omoSource='https://hoshinoresorts.com/ja/hotels/omo7osaka/dining/',darumaSource='https://www.kushikatu-daruma.com/location/doubutsuenmae';
 D.places.push(
  {...extra('omo-lunch55','OMO7 카페 & 바 · 점심과 휴식',[34.6514,135.5027],'돈키 쇼핑 후 역 가까운 카페에서 나폴리탄과 커피. 멀리 이동하지 않고 출국 전 쉬는 선택.',omoSource,'food'),group:'cafe',area:'shinsekai',areaLabel:'신이마미야',address:'大阪市浪速区恵美須西3-16-30 OMO7大阪 2F',duration:120,price:1500,priceText:'나폴리탄 1000엔 + 커피 500엔'},
  {...extra('daruma-lunch55','쿠시카츠 다루마 · 도부츠엔마에점',[34.6513,135.5060],'돈키 가까운 지점에서 소고기·새우·채소 꼬치튀김으로 점심. 신세카이 관광을 반복하지 않고 식사만.',darumaSource,'food'),group:'fried',area:'shinsekai',areaLabel:'신세카이',address:'大阪市浪速区恵美須東2-4-5',duration:45,price:2000,priceText:'공식 평균 예산 1500–2500엔'}
 );
 D.details['omo-lunch55']={why:'쇼핑 봉투를 들고 먼 식당으로 가지 않아도 되는 쉬는 코스. 카페 이용객은 정원도 이용 가능하지만 일반 무료 공원은 아닙니다.',order:'공식 낮 메뉴: 나폴리탄 1000엔 + 커피 500엔. 가라아게 650엔은 나눠 먹기 선택. 모두 세금 포함, 현장 변경 가능.',tip:'카페 낮 메뉴 10–18시, 숙박하지 않아도 이용 가능·숙박객 우선. 120분은 식사 약60분 + 휴식45분 + 대기15분 계획값이며 자리 보장 아님. 14:30 종료. 혼잡하면 테이크아웃 후 역으로.',source:omoSource};
 D.details['daruma-lunch55']={why:'돈키에서 걸어갈 수 있는 오사카식 꼬치튀김 점심. 신사·쇼핑을 모두 한 날이라 별도 번화가로 이동하지 않기.',order:'소고기·새우·아스파라거스 등 꼬치 + 도테야키를 나눠 주문. 공식 평균 예산 1인1500–2500엔. 성인은 음료 1잔 주문 필요(술 필수 아님).',tip:'월요일 11–22:30 안내. 예약된 식사가 아니며 대기15분 넘으면 가까운 빠른 식사로 교체. 14:30 식사 종료, 공항 출발은 늦추지 않기.',source:darumaSource};
 D.days.mon=[
  {id:'mon-donki54',label:'A · 돈키 2시간 → 카페 점심·휴식',tag:'여유형 · 돈키 필수',why:'MEGA 돈키에서 충분히 쇼핑하고 역 근처 OMO7에서 점심과 커피. 관광을 억지로 추가하지 않는 가장 편한 마지막 날.',note:'돈키10:15–12:15 → 점심·휴식12:30–14:30 → 짐 회수14:45 → 15시 공항행. '+flightNote,stops:[s('breakfast45','08:15',30,15,'breakfast'),s('checkout45','09:00',30,15),s('shinimamiya-locker54','09:45',15,15),s('donki-mega54','10:15',120,15,'','필수. 11:45부터 계산·포장 준비, 12:15 쇼핑 종료.'),s('omo-lunch55','12:30',120,15,'lunch','나폴리탄 점심 후 커피·휴식. 14:30에는 카페를 떠나 로커로.'),s('shinimamiya-airport54','14:45',15,0)]},
  {id:'mon-shrine-donki54',label:'B · 스미요시 신사 → 돈키 → 꼬치 점심',tag:'관광형 · 돈키 필수',why:'남쪽 신사의 붉은 다리·본전, 대형 돈키 쇼핑, 오사카 꼬치 점심을 묶었습니다. 북쪽 우메다까지 왕복하지 않습니다.',note:'신사10:30–11:15 → 돈키12–13:30 → 꼬치13:45–14:30. 큰 짐은 신이마미야에 보관. 늦어지면 신사 또는 식당 대기를 줄이기. '+flightNote,stops:[s('breakfast45','08:00',30,15,'breakfast'),s('checkout45','08:45',30,15),s('shinimamiya-locker54','09:30',15,45),s('sumiyoshi53','10:30',45,45),s('donki-mega54','12:00',90,15,'','필수. 13시부터 계산·포장, 13:30 쇼핑 종료.'),s('daruma-lunch55','13:45',45,15,'lunch','꼬치튀김 점심. 줄이 15분 넘으면 빠른 근처 식사로 교체.'),s('shinimamiya-airport54','14:45',15,0)]},
  {id:'mon-donki-rinku54',label:'C · 돈키 2시간 → 린쿠 점심·바닷가',tag:'공항 방향 · 돈키 필수',why:'대형 돈키를 먼저 끝내고 남쪽 린쿠로 이동. 점심을 먹고 바닷가 풍경 또는 관심 브랜드 한 곳만 보고 공항으로 갑니다.',note:'돈키09–11시 → 짐 회수11:15 → 린쿠 점심13시 → 14시 바닷가·한 매장 → 15시 공항행. 더위·무거운 짐·열차 지연이면 린쿠를 생략하고 공항으로. '+flightNote,stops:[s('breakfast45','07:00',30,15,'breakfast'),s('checkout45','07:45',30,15),s('shinimamiya-locker54','08:30',15,15),s('donki-mega54','09:00',120,15,'','필수. 10:30부터 계산·포장 준비. 개점 전 입장 불가.'),s('shinimamiya-pickup54','11:15',15,60),s('rinku-locker53','12:30',15,15),s('rinku-lunch53','13:00',45,15,'lunch'),s('rinku53','14:00',30,15,'','관심 브랜드 한 곳 또는 Sea Side 바다 풍경만. 돈키가 주 쇼핑이므로 아웃렛 전체 순회는 생략.'),s('rinku-airport53','14:45',15,0)]}
 ];
