const CACHE = 'osaka-guide-local-v1';
const SHELL = [
  ...
  './osaka-vnext-data.js?v=40', './vnext-core.js?v=40', './planner-v3.js?v=42', './vnext.js?v=40',
  './today-core.js?v=43', './today.js?v=43', './guide-theme.css?v=42', './today.css?v=43',
