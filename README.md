...
- v55: Corrected Monday flight to user-confirmed 18:00, with 16:00 terminal target and 15:00 airport-bound departure. All three MEGA Donki routes now include lunch and activities/rest until 14:30: OMO7 cafe, Sumiyoshi + Daruma, or Rinku. Today prompts, scheduling deadlines, route map, departure calculator and offline cache are aligned; T2/heavy baggage require earlier departure. Saved plans remain unchanged until Apply Monday. Official cafe menu and restaurant hours checked; airline/terminal, live train departures and reservations are not verified.
