...
const ctx={window:{}};for(const f of ['curated-v45.js','curated-rich47.js','route-transport48.js'])vm.runInNewContext(fs.readFileSync(__dirname+'/docs/'+f,'utf8'),ctx);
...
assert.match(d('castle','kaiyukan',60).route,/모리노미야/);assert.equal(d('zundo-doton45','dotonbori-night-v3',15).travelmode,'walking');
